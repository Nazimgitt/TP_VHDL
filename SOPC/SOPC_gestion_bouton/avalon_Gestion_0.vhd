...
entity avalon_Gestion_0 is
	port (
		...
		BP_STBY    : in  std_logic                     := '0';             --  conduit_end_1.export
		BP_Tribord : in  std_logic                     := '0';             --               .export
		BP_Babord  : in  std_logic                     := '0'              --               .export
	);
...
begin
	...
	avalon_gestion_0 : component avalon_Gestion
		port map (
			...
			ledSTBY    => ledSTBY,    --               .export
			ledTribord => ledTribord, --               .export
			ledBabord  => ledBabord,  --               .export
			BP_STBY    => BP_STBY,    --  conduit_end_1.export
			BP_Tribord => BP_Tribord, --               .export
			BP_Babord  => BP_Babord   --               .export
		);
